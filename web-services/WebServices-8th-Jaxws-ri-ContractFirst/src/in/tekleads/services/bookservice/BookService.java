 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://tekleads.in/services/BookService/", wsdlLocation = "file:/D:/web-services/WebServices-8th-Jaxws-ri-ContractFirst/BookService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICE_QNAME = new QName("http://tekleads.in/services/BookService/", "BookService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/web-services/WebServices-8th-Jaxws-ri-ContractFirst/BookService.wsdl");
    ...
    public IBookService getBookServicePort() {
        return super.getPort(new QName("http://tekleads.in/services/BookService/", "BookServicePort"), IBookService.class);
    }
    ...
    public IBookService getBookServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tekleads.in/services/BookService/", "BookServicePort"), IBookService.class, features);
    }
